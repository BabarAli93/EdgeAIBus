...
class DatacenterGeneration:
    def __init__(self, nums: dict, metrics: dict, nodes_cap_rng:dict, container_conf: dict, 
                 num_steps: int, datacenter_start_time: int, datacenter_end_time: int,
                 seed: int, contexts: list, images: list,
                 versions: list, config_path: str):
