...
from datacenter.utils import logger
        ...
        try:
            ...
            for container in pod.spec.containers:
                if container.resources.requests:
                    cpu_request += int(container.resources.requests.get('cpu', '0').rstrip('m'))
                    memory_request += int(container.resources.requests.get('memory', '0').rstrip('Mi'))
            
            cpu_request = str(cpu_request) + 'm'
            memory_request = str(memory_request) + 'Mi'
