...
class KubeEdgeEnv(gym.Env, Scheduler):
    ...
    def step(self, action):
        ...
        self.datacenter.hosts_pull = self.datacenter.containers_pull = self.yolosla_processed = False
        ...
        # TODO: It should be calculated using the actual usage of nodes
        if self.no_action_on_overload and num_overloaded > 0:
            ...
            # TODO: call migrate and update all the params of ip_model_image there
            ip_model_image = self.datacenter.migrate(gke_action)
    ...
    def observation(self) -> np.ndarray:
        ...
        observation = {
            ...
            "hosts_resources_req": self.datacenter.hosts_resources_requested()[:,1:],
