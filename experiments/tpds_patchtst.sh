...
### This script extract the CPU and memory usages from the Intel Machines 

UNIT=patchtst-job
SLICE=patchtst.slice
EXPERIMENT_CMD= path of the python file
DURATION=7200
INTERVAL=1

RAPL_PATH="/sys/class/powercap/intel-rapl:0/energy_uj"
LOGFILE="ptst_300mc_log_$(date +%F_%T).csv"
OUT_LOG="ptst_output_300_$(date +%F_%T).log"
ERR_LOG="ptst_error_300_$(date +%F_%T).err"
